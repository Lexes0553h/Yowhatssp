...
export const curatedDestinations: Destination[] = [
  {
    ...
    location: 'Indonesia',
    rating: 4.85,
    bgImage: 'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=2400&q=80', // Luxury jungle pool
    secondaryImages: [
  ...
  },
  {
    ...
    rating: 4.9,
    bgImage: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=2400&q=80', // Beautiful turquoise aerial
    secondaryImages: [
  ...
  },
  {
    ...
    rating: 4.88,
    bgImage: 'https://images.unsplash.com/photo-1555921015-5532091f6026?auto=format&fit=crop&w=2400&q=80', // Ha Long Bay
    secondaryImages: [
      'https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=800&q=80',
